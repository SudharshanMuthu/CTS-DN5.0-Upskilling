...
-- insert query to insert the values intable 
INSERT INTO Users
...
-- select comment yethuku use panurom tbles ula values pakka 
select * from users;
-- desc kuduthu patha table la ula files key yatha katum not values it show structure 
desc users;
